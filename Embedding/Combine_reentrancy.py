...
key_words = ["call"]
prefixes = r'\b(call)\b'
postfixes = r'\b(balance|balances)\b'
...
if confirm_pre:
    ...
    for i in range(1, total_vuln + 1):
        input_vuln_file_path = f"/home/antiransom/Unsupervised/Contracts/vuln/reentrancy/{i}.sol"
        output_vuln_file_path = f"/home/antiransom/Unsupervised/Contracts/vuln/reentrancy/{i}.txt"
    ...
    for i in range(1, total_clean + 1):
        input_clean_file_path = f"/home/antiransom/Unsupervised/Contracts/clean/{i}.sol"
        output_clean_file_path = f"/home/antiransom/Unsupervised/Contracts/clean/189/{i}.txt"
...
documents_path = '/home/antiransom/Unsupervised/Contracts/vuln/reentrancy/'  # Replace with your actual directory path
documents_path2 = '/home/antiransom/Unsupervised/Contracts/clean/189/'
...
word2vec_model = Word2Vec(documents, vector_size=10, window=5, min_count=1, workers=4, sg=1, epochs=10, seed=1194)
...
for doc in corpus:
    for word_id, score in tfidf_model[doc]:
        word = dictionary[word_id]
        if score > 0.7 and (word not in tfidf_scores or score > tfidf_scores[word]):
...
print("\nWords with TF-IDF score > 0.7 (sorted by score):")
