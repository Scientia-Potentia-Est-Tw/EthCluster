...
with open('../Contracts/vuln/access_control/mix_new/document_vectors.pkl', 'wb') as f:
    pickle.dump(document_vectors, f)
    
word2vec_model.save("../Contracts/vuln/access_control/mix_new/word2vec_model.model")